...
public class Botnia extends AppCompatActivity {
    ImageView date,cash,group,call;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_botnia);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder alert = new AlertDialog.Builder(Botnia.this);
                alert.setTitle("Date");
        ...
        cash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alert.setMessage("1st Prize- Rs.3000\n" +
                        "2nd Prize -Rs.2000");
                alert.setPositiveButton("OK", null);
                alert.show();
            }
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alert.setMessage("Mahesh HG-9035663465\nThanush S-8867768009\nTejaswini Beliraya K-9483912008\n");
                alert.setPositiveButton("OK", null);
                alert.show();
            }
        });
