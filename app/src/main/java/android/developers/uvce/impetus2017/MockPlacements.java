...
public class MockPlacements extends AppCompatActivity {
    ImageView date,cash,group,call;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mock_placements);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder alert = new AlertDialog.Builder(MockPlacements.this);
                alert.setTitle("Date");
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alert.setMessage("Arun-8553100382");
                alert.setPositiveButton("OK", null);
                alert.show();
            }
        });
