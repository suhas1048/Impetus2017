...
public class TheAlchemist extends AppCompatActivity {
    ImageView date,cash,group,call;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_the_alchemist);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder alert = new AlertDialog.Builder(TheAlchemist.this);
                alert.setTitle("Date");
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alert.setMessage("Vaaruni Desai-7411707456\nShreya Uday-9880049825\nJishnu S M-7353120520");
                alert.setPositiveButton("OK", null);
                alert.show();
            }
        });
