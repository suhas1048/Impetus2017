...
public class TechAndLadder extends AppCompatActivity {
    ImageView date,cash,group,call;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tech_and_ladder);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder alert = new AlertDialog.Builder(TechAndLadder.this);
                alert.setTitle("Date");
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alert.setMessage("Ganesh N Sharma-9164267500\nSanchay DC-8747801211\nVindith Kamath-9480440283");
                alert.setPositiveButton("OK", null);
                alert.show();
            }
        });
