...
// refresh complete
    ...
    private void sendRequest() {
        ...
        webView.loadUrl("http://www.impetus17.com/#/");
        pd = ProgressDialog.show(Website.this, "Refreshing",
                "Please wait", true);
    ...
    private class MyBrowser extends WebViewClient {
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            Toast.makeText(Website.this,"You dont seem to have an active internet connection,Please try again later", Toast.LENGTH_SHORT).show();
